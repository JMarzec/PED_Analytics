...
// importing variables
$iframe_directory = "$relative_root_dir/ped_backoffice/data/icgc_PAEN-AU/";
$result_directory = "$absolute_root_dir/ped_backoffice/data/icgc_PAEN-AU/";
...
echo <<< EOT
  ...
  <div class="container" id="icgc_results">
    ...
    <div id="expression_profiles">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("gea_icgc_sel", "", "", "icgc_PAEN-AU")</script>
      <script>LoadAnalysis("gea_icgc_sel","gea_icgc_run","icgc","","icgc_PAEN-AU_gene_expression","0")</script>
    </div>
    ...
    <div id="co_expression_analysis">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("cea_icgc_sel", "", "", "icgc_PAEN-AU")</script>
      <script>LoadAnalysis("cea_icgc_sel","cea_icgc_run","icgc","","icgc_PAEN-AU_co_expression","1")</script>
    </div>
    ...
    <div id="expression_layering">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("el_icgc_sel", "", "", "icgc_PAEN-AU")</script>
      <script>LoadAnalysis("el_icgc_sel","el_icgc_run","icgc","","icgc_PAEN-AU_expression_layering","1")</script>
    </div>
    ...
    <div id="gene_copy_number">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("cna_icgc_sel", "", "", "icgc_PAEN-AU_cnv")</script>
      <script>LoadAnalysis("cna_icgc_sel","cna_icgc_run","icgc","","icgc_PAEN-AU_gene_copy_number","1")</script>
    ...
    <div id="survival">
      ...
      <!-- Calling Javascripts -->
      <script>LoadGeneSelector("surv_icgc_sel", "", "", "icgc_PAEN-AU")</script>
      <script>LoadAnalysis("surv_icgc_sel","surv_icgc_run","icgc","","icgc_PAEN-AU_survival","0")</script>
    </div>
...
EOT;
  ...
  echo <<< EOT
      ...
      <script>LoadGeneSelector('icgc_net_sel','','','icgc_PAEN-AU')</script>
      <script>LoadAnalysis('icgc_net_sel','icgc_run_net','','','icgc_PAEN-AU_gene_network','0')</script>
    </div>
  </div>
