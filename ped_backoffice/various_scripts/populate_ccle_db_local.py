...
with open(ccle_file, 'r') as f:
    ...
    for line in f:
        ...
        cur.execute("INSERT INTO ccle(name, target, cell_type, gender, ethnicity, age, er, pr, her2) VALUES ( \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\");" % (name, target, cell_type, gender, ethnicity, age, er, pr, her2))
