...
################################################################################
#
#   Description: Script preparing relative linear copy-number values data for generating circos plot. The pipeline calls gained and lost genes by estimating the putative copy-number alterations from the linear copy-number values. It assigns gain for linear CN values above 0.5 and loss for linear CN values below -0.5. It retrieves gene's chromosomal positions using biomaRt R package. NOTE: the script allowes to process gene matrix with duplicated gene IDs.
#
